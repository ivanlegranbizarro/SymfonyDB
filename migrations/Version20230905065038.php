 ...
 */
final class Version20230905065038 extends AbstractMigration
{
  public function getDescription(): string
  {
    return 'Initial setup with comments, products, tags and metadata';
  }
  ...
  public function up(Schema $schema): void
  {
    ...
    $this->addSql('CREATE TABLE metadata (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, code VARCHAR(255) NOT NULL, content VARCHAR(255) NOT NULL)');
